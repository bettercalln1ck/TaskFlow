...
- **Run tests** (from repo root `TaskWare/`):
  ...
  xcodebuild test -project TaskWare.xcodeproj -scheme TaskWare \
    -destination 'platform=iOS Simulator,id=5BFEB98A-4E1D-458F-B3D4-89E600F1B9A5' \
    -only-testing:TaskWareTests/<TestClass> 2>&1 | tail -40
  ```
- **Build the app:**
  ```bash
  xcodebuild build -project TaskWare.xcodeproj -scheme TaskWare \
    -destination 'platform=iOS Simulator,id=5BFEB98A-4E1D-458F-B3D4-89E600F1B9A5' 2>&1 | tail -40
  ```
...
Run: `xcodebuild test -project TaskWare.xcodeproj -scheme TaskWare -destination 'platform=iOS Simulator,id=5BFEB98A-4E1D-458F-B3D4-89E600F1B9A5' -only-testing:TaskWareTests/SmokeTests 2>&1 | tail -30`
...
```bash
xcodebuild test -project TaskWare.xcodeproj -scheme TaskWare \
  -destination 'platform=iOS Simulator,id=5BFEB98A-4E1D-458F-B3D4-89E600F1B9A5' 2>&1 | tail -60
```
...
xcodebuild build -project TaskWare.xcodeproj -scheme TaskWare \
  -destination 'platform=iOS Simulator,id=5BFEB98A-4E1D-458F-B3D4-89E600F1B9A5' -derivedDataPath build 2>&1 | tail -5
